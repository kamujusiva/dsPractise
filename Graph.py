...
#########################################################################
# The Class "AdjacencyMatrixGraph" represents a graph as an adjacency matrix. A cell in matrix has a value when there
# exists an edge between the vertex represented by the row and column numbers.
